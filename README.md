...
1. Install the List using the apropriate [Wabbajack](https://github.com/wabbajack-tools/wabbajack/releases) version, which in 99% of the cases is the latest one.
